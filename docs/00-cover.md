...
* [Resultado de Aprendizaje (Student Outcome)](00-cover.md#student-outcome)
* [Capítulo I: Introducción](01-cha01-introduction.md#capítulo-i-introducción)
   * [1.1. Perfil de la Startup](01-cha01-introduction.md#11-startup-profile)
   ...
   * [1.2. Perfil de la Solución](01-cha01-introduction.md#12-solution-profile)
      * [1.2.1. Antecedentes y problemática](01-cha01-introduction.md#121-antecedentes-y-problemática)
      * [1.2.2. Proceso Lean UX](01-cha01-introduction.md#122-lean-ux-process)
         * [1.2.2.1. Declaraciones del Problema (Lean UX)](01-cha01-introduction.md#1221-lean-ux-problem-statements)
         * [1.2.2.2. Supuestos (Lean UX)](01-cha01-introduction.md#1222-lean-ux-assumptions)
         * [1.2.2.3. Declaraciones de Hipótesis (Lean UX)](01-cha01-introduction.md#1223-lean-ux-hypothesis-statements)
         * [1.2.2.4. Lienzo Lean UX](01-cha01-introduction.md#1224-lean-ux-canvas)
   * [1.3. Segmentos objetivo](01-cha01-introduction.md#13-segmentos-objetivo)
* [Capítulo II: Elicitación y Análisis de Requisitos](02-cha02-requirements-elicitation-and-analysis.md#capítulo-ii-requirements-elicitation--analysis)
   ...
   * [2.3. Detección de Necesidades (Needfinding)](02-cha02-requirements-elicitation-and-analysis.md#23-needfinding)
      * [2.3.1. Personas de Usuario](02-cha02-requirements-elicitation-and-analysis.md#231-user-personas)
      * [2.3.2. Matriz de Tareas de Usuario](02-cha02-requirements-elicitation-and-analysis.md#232-user-task-matrix)
      * [2.3.3. Mapa de Empatía](02-cha02-requirements-elicitation-and-analysis.md#233-empathy-mapping)
      * [2.3.4. Mapeo de Escenario Actual (As-Is)](02-cha02-requirements-elicitation-and-analysis.md#234-as-is-scenario-mapping)
   * [2.4. Lenguaje Ubicuo](02-cha02-requirements-elicitation-and-analysis.md#24-ubiquitous-language)
* [Capítulo III: Especificación de Requisitos](03-cha03-requirements-specification.md#capítulo-iii-requirements-specification)
   * [3.1. Mapeo de Escenario Futuro (To-Be)](03-cha03-requirements-specification.md#31-to-be-scenario-mapping)
   * [3.2. Historias de Usuario](03-cha03-requirements-specification.md#32-user-stories)
   * [3.3. Mapeo de Impacto](03-cha03-requirements-specification.md#33-impact-mapping)
   * [3.4. Backlog del Producto](03-cha03-requirements-specification.md#34-product-backlog)
* [Capítulo IV: Diseño de Software a Nivel Estratégico](04-cha04-strategic-level-software-design.md#capítulo-iv-strategic-level-software-design)
   * [4.1. Diseño Guiado por Atributos a Nivel Estratégico](04-cha04-strategic-level-software-design.md#41-strategic-level-attribute-driven-design)
      * [4.1.1. Propósito del Diseño](04-cha04-strategic-level-software-design.md#411-design-purpose)
      * [4.1.2. Entradas del Diseño Guiado por Atributos](04-cha04-strategic-level-software-design.md#412-attribute-driven-design-inputs)
         * [4.1.2.1. Funcionalidad Principal (Historias de Usuario Principales)](04-cha04-strategic-level-software-design.md#4121-primary-functionality-primary-user-stories)
         * [4.1.2.2. Escenarios de Atributos de Calidad](04-cha04-strategic-level-software-design.md#4122-quality-attribute-scenarios)
         * [4.1.2.3. Restricciones](04-cha04-strategic-level-software-design.md#4123-constraints)
      * [4.1.3. Backlog de Impulsores Arquitectónicos](04-cha04-strategic-level-software-design.md#413-architectural-drivers-backlog)
      * [4.1.4. Decisiones de Diseño Arquitectónico](04-cha04-strategic-level-software-design.md#414-architectural-design-decisions)
      * [4.1.5. Refinamientos de Escenarios de Atributos de Calidad](04-cha04-strategic-level-software-design.md#415-quality-attribute-scenario-refinements)
   * [4.2. Diseño Guiado por el Dominio a Nivel Estratégico](04-cha04-strategic-level-software-design.md#42-strategic-level-domain-driven-design)
      * [4.2.1. EventStorming](04-cha04-strategic-level-software-design.md#421-eventstorming)
      * [4.2.2. Descubrimiento de Contextos Candidatos](04-cha04-strategic-level-software-design.md#422-candidate-context-discovery)
      * [4.2.3. Modelado de Flujos de Mensajes del Dominio](04-cha04-strategic-level-software-design.md#423-domain-message-flows-modeling)
      * [4.2.4. Lienzos de Contexto Delimitado](04-cha04-strategic-level-software-design.md#424-bounded-context-canvases)
      * [4.2.5. Mapeo de Contextos](04-cha04-strategic-level-software-design.md#425-context-mapping)
   * [4.3. Arquitectura de Software](04-cha04-strategic-level-software-design.md#43-software-architecture)
      * [4.3.1. Diagrama de Panorama del Sistema (Arquitectura de Software)](04-cha04-strategic-level-software-design.md#431-software-architecture-system-landscape-diagram)
      * [4.3.1. Diagramas de Nivel de Contexto (Arquitectura de Software)](04-cha04-strategic-level-software-design.md#431-software-architecture-context-level-diagrams)
      * [4.3.2. Diagramas de Nivel de Contenedor (Arquitectura de Software)](04-cha04-strategic-level-software-design.md#432-software-architecture-container-level-diagrams)
      * [4.3.3. Diagramas de Despliegue (Arquitectura de Software)](04-cha04-strategic-level-software-design.md#433-software-architecture-deployment-diagrams)
* [Capítulo V: Diseño de Software a Nivel Táctico](05-cha05-tactical-level-software-design.md#capítulo-v-tactical-level-software-design)
   * [5.1. Contexto Delimitado: \<Nombre del Contexto Delimitado\>](05-cha05-tactical-level-software-design.md#5x-bounded-context-bounded-context-name)
      * [5.1.1. Capa de Dominio](05-cha05-tactical-level-software-design.md#5x1-domain-layer)
      * [5.1.2. Capa de Interfaz](05-cha05-tactical-level-software-design.md#5x2-interface-layer)
      * [5.1.3. Capa de Aplicación](05-cha05-tactical-level-software-design.md#5x3-application-layer)
      * [5.1.4. Capa de Infraestructura](05-cha05-tactical-level-software-design.md#5x4-infrastructure-layer)
      * [5.1.6. Diagramas de Nivel de Componente del Contexto Delimitado](05-cha05-tactical-level-software-design.md#5x6-bounded-context-software-architecture-component-level-diagrams)
      * [5.1.7. Diagramas de Nivel de Código del Contexto Delimitado](05-cha05-tactical-level-software-design.md#5x7-bounded-context-software-architecture-code-level-diagrams)
         * [5.1.7.1. Diagramas de Clases de la Capa de Dominio del Contexto Delimitado](05-cha05-tactical-level-software-design.md#5x71-bounded-context-domain-layer-class-diagrams)
         * [5.1.7.2. Diagrama de Diseño de Base de Datos del Contexto Delimitado](05-cha05-tactical-level-software-design.md#5x72-bounded-context-database-design-diagram)
* [Capítulo VI: Diseño UX de la Solución](06-cha06-solution-ux-design.md#capítulo-vi-solution-ux-design)
   * [6.1. Guías de Estilo](06-cha06-solution-ux-design.md#61-style-guidelines)
      * [6.1.1. Guías de Estilo Generales](06-cha06-solution-ux-design.md#611-general-style-guidelines)
      * [6.1.2. Guías de Estilo Web, Móvil y Dispositivos](06-cha06-solution-ux-design.md#612-web-mobile--devices-style-guidelines)
   * [6.2. Arquitectura de Información](06-cha06-solution-ux-design.md#62-information-architecture)
      * [6.2.2. Sistemas de Etiquetado](06-cha06-solution-ux-design.md#622-labeling-systems)
      * [6.2.3. Sistemas de Búsqueda](06-cha06-solution-ux-design.md#623-searching-systems)
      * [6.2.4. Etiquetas SEO y Meta Etiquetas](06-cha06-solution-ux-design.md#624-seo-tags-and-meta-tags)
      * [6.2.5. Sistemas de Navegación](06-cha06-solution-ux-design.md#625-navigation-systems)
   * [6.3. Diseño UI de la Landing Page](06-cha06-solution-ux-design.md#63-landing-page-ui-design)
      * [6.3.1. Wireframe de la Landing Page](06-cha06-solution-ux-design.md#631-landing-page-wireframe)
      * [6.3.2. Mock-up de la Landing Page](06-cha06-solution-ux-design.md#632-landing-page-mock-up)
   * [6.4. Diseño UX/UI de las Aplicaciones](06-cha06-solution-ux-design.md#64-applications-uxui-design)
      * [6.4.1. Wireframes de las Aplicaciones](06-cha06-solution-ux-design.md#641-applications-wireframes)
      * [6.4.2. Diagramas de Wireflow de las Aplicaciones](06-cha06-solution-ux-design.md#642-applications-wireflow-diagrams)
      * [6.4.2. Mock-ups de las Aplicaciones](06-cha06-solution-ux-design.md#642-applications-mock-ups)
      * [6.4.3. Diagramas de Flujo de Usuario de las Aplicaciones](06-cha06-solution-ux-design.md#643-applications-user-flow-diagrams)
   * [6.5. Prototipado de las Aplicaciones](06-cha06-solution-ux-design.md#65-applications-prototyping)
* [Capítulo VII: Implementación, Validación y Despliegue del Producto](07-cha07-product-implementation-validation-and-deployment.md#capítulo-vii-product-implementation-validation--deployment)
   * [7.1. Gestión de la Configuración del Software](07-cha07-product-implementation-validation-and-deployment.md#71-software-configuration-management)
      * [7.1.1. Configuración del Entorno de Desarrollo de Software](07-cha07-product-implementation-validation-and-deployment.md#711-software-development-environment-configuration)
      * [7.1.2. Gestión del Código Fuente](07-cha07-product-implementation-validation-and-deployment.md#712-source-code-management)
      * [7.1.3. Guía de Estilo y Convenciones del Código Fuente](07-cha07-product-implementation-validation-and-deployment.md#713-source-code-style-guide--conventions)
      * [7.1.4. Configuración del Despliegue del Software](07-cha07-product-implementation-validation-and-deployment.md#714-software-deployment-configuration)
   * [7.2. Implementación de la Solución](07-cha07-product-implementation-validation-and-deployment.md#72-solution-implementation)
      * [7.2.1. Sprint 1](07-cha07-product-implementation-validation-and-deployment.md#72x-sprint-n)
         * [7.2.1.1. Planificación del Sprint 1](07-cha07-product-implementation-validation-and-deployment.md#72x1-sprint-planning-n)
         * [7.2.1.2. Backlog del Sprint 1](07-cha07-product-implementation-validation-and-deployment.md#72x2-sprint-backlog-n)
         * [7.2.1.3. Evidencia de Desarrollo para la Revisión del Sprint](07-cha07-product-implementation-validation-and-deployment.md#72x3-development-evidence-for-sprint-review)
         * [7.2.1.4. Evidencia de Pruebas para la Revisión del Sprint](07-cha07-product-implementation-validation-and-deployment.md#72x4-testing-suite-evidence-for-sprint-review)
         * [7.2.1.5. Evidencia de Ejecución para la Revisión del Sprint](07-cha07-product-implementation-validation-and-deployment.md#72x5-execution-evidence-for-sprint-review)
         * [7.2.1.6. Evidencia de Documentación de Servicios para la Revisión del Sprint](07-cha07-product-implementation-validation-and-deployment.md#72x6-services-documentation-evidence-for-sprint-review)
         * [7.2.1.7. Evidencia de Despliegue de Software para la Revisión del Sprint](07-cha07-product-implementation-validation-and-deployment.md#72x7-software-deployment-evidence-for-sprint-review)
         * [7.2.1.8. Percepciones de Colaboración del Equipo durante el Sprint](07-cha07-product-implementation-validation-and-deployment.md#72x8-team-collaboration-insights-during-sprint)
   * [7.3. Entrevistas de Validación](07-cha07-product-implementation-validation-and-deployment.md#73-validation-interviews)
   ...
   * [7.4. Video Sobre el Producto](07-cha07-product-implementation-validation-and-deployment.md#74-video-about-the-product)
* [Conclusiones](08-conclusions.md#conclusiones)
   ...
   * [Video Sobre el Equipo](08-conclusions.md#video-about-the-team)
