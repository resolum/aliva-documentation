...
<table>
    ...
    <tr>
        ...
        <td colspan="5">Conocer qué tan cubierta está la necesidad de autonomía en el hogar de personas con discapacidad motora severa, y validar si el enfoque offline de Alivia representa una ventaja real frente al resto del mercado.</td>
    </tr>
    <tr>
        <th colspan="2"></th>
    ...
    <tr>
        ...
        <td>Solución especializada en la autonomía y supervisión de personas con discapacidad motora severa.</td>
    ...
    <tr>
        ...
        <td>Hogares con algún miembro con discapacidad motora severa, junto a sus cuidadores.</td>
...
De las entrevistas se desprende claramente que una persona con discapacidades motoras depende de un familiar cercano para realizar las tareas del hogar básicas sin utilizar ningún tipo de ayuda tecnológica. El 100% de las personas entrevistadas tienen una discapacidad motora de diversos tipos: Parálisis Cerebral en la Entrevista 1, Esclerosis Múltiple en la Entrevista 2 y Post-caída en la Entrevista 3. Además el 100% de las personas entrevistadas manifestaron que utilizan una silla de ruedas como medio de transporte y tienen que buscar la ayuda de un familiar cercano —un padre, una madre o una tía— para llevar a cabo sus rutinas diarias.

Cuando se habla del uso de la tecnología el 100% de las personas entrevistadas usan un teléfono celular como su dispositivo para hacer llamadas y usan WhatsApp en situaciones de emergencia. Sin embargo el 67% (Entrevistas 2 y 3) de los entrevistados manifestaron que nunca habían usado ningún tipo de dispositivo o tecnología para ayudarlos en sus tareas del hogar. Esto demuestra claramente que existe una brecha en el acceso a estas tecnologías. El 33% (Entrevista 1) de los entrevistados tenían conocimientos y experiencia previa en programación y el uso de control de voz pero no pudieron instalar un sistema de automatización del hogar ya que no tenían información acerca de las soluciones comerciales para el problema y las limitaciones económicas.

Hablando de las actividades difíciles el 100% de los entrevistados tienen dificultades para controlar la luz, la puerta y la ventana de su habitación sin ayuda alguna. En la Entrevista 2 la entrevistada dice que no tiene posibilidad de usar el interruptor debido a su silla de ruedas y en la Entrevista 1 el entrevistado menciona que aunque utiliza la silla de ruedas como medio de transporte todavía tiene sus viejas muletas para ayudarlo temporalmente a abrir la puerta y la ventana.

Desde la perspectiva subjetiva el 100% de los entrevistados tienen una actitud positiva hacia el uso de un sistema para controlar estos objetos en sus hogares. Además el 33% (Entrevista 1) de los entrevistados prefieren el control de voz en lugar del gesto o los movimientos ya que de esta forma es más inclusivo para aquellos que no pueden mover sus extremidades. La tendencia común en las tres entrevistas es que la falta de independencia los frustra y afecta su bienestar emocional y su sentido de control.

![Gráfico Estadístico Persona con Discapacidad Motora Severa](https://imgur.com/ikIAYeN.png)

En resumen podemos decir que una persona con discapacidades motoras querría ser independiente de cualquier tipo de ayuda para controlar objetos básicos a su alrededor (como una luz, una puerta o una ventana) pero requiere una solución que sea fácil de usar, asequible y que principalmente utilice comandos de voz para la comunicación.

---

#### Segmento 2: Familiar o cuidador de persona con discapacidad

**Análisis de Características Objetivas y Subjetivas:**

Las entrevistas muestran que un miembro de la familia o un cuidador de la persona que sufre una discapacidad motora está ocupado con las actividades de cuidado de esta persona durante una parte significativa del día: moverla, alimentarla e higienizarla. El 100% de las personas entrevistadas dan este tipo de asistencia pero de manera diferente organizadas en sus turnos: el 67% (Entrevistas 2 y 3) comparten sus turnos con sus hermanos u otros personal de apoyo mientras que el 33% (Entrevista 1) asumen estas responsabilidades casi de forma independiente, cooperando con otros miembros de la familia solo en algunos casos.

En cuanto al uso de la tecnología el 100% de los entrevistados usan un teléfono celular como el principal dispositivo de comunicación durante su turno. Pero solo el 33% (Entrevista 3) tienen alguna experiencia previa usando cámaras de vigilancia sincronizadas con una aplicación en su teléfono celular para controlar tanto a su familiar como al personal contratado. El 67% (Entrevistas 1 y 2) nunca han usado ninguna ayuda tecnológica o sistema de cuidado.

Hablando de las tareas más difíciles el 100% de los entrevistados consideran que su mayor problema es la falta de alguien que los reemplace durante sus turnos. Así en la primera entrevista el entrevistado menciona que en estos casos la impotencia de su tío ante una necesidad fisiológica puede ocurrir; en la segunda entrevista la entrevistada dice que en este caso su padre se queda en la cama hasta que un miembro de la familia venga a ayudarlo; en la tercera entrevista el entrevistado tenía miedo de un accidente como caerse o atragantarse.

Desde el punto de vista de la subjetividad el 100% de los entrevistados tienen una actitud positiva hacia el uso de un sistema que permita a su familiar ser autónomo en la realización de las tareas básicas del hogar. Además el 33% (Entrevista 1) tienen la preferencia de recibir notificaciones de texto en vez de mensajes de voz ya que estos últimos son difíciles de contestar mientras se estudia o se camina por la calle. La característica transversal de las tres entrevistas es la necesidad de brindar garantías de seguridad absolutas, la cual los entrevistados consideran indispensable para el uso de cualquier dispositivo tecnológico.

![Gráfico Estadístico Familiar o Cuidador](https://imgur.com/1GA1C0b.png)

En resumen el miembro de la familia o un cuidador intenta disminuir tanto la carga física como la psicológica que implica el cuidado de una persona con una discapacidad motora importante, pero este requiere una solución que le ofrezca un seguimiento confiable y continuo, priorizando la seguridad como requisito principal.
