...
| RNF27  | Restricción de Implementación (Datos de la Aplicación) | El sistema debe utilizar MongoDB para persistir los datos estructurados generados por la aplicación, como preferencias, estados de dispositivos, alertas y eventos de supervisión, manteniendo PostgreSQL para la información transaccional del servicio, como cuentas, contrataciones, pagos, suscripciones e instalaciones. |
