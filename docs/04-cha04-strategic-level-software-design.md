...
| US24      | Confirmación y atención de alertas críticas            | La arquitectura debe gestionar el ciclo completo de las alertas críticas, diferenciando su confirmación, el inicio de atención y su resolución, deteniendo las repeticiones después de la confirmación y conservando la trazabilidad del responsable, momento y resultado.                                                            | High                          | High                                         |
...
| TS-27     | Desarrollo móvil nativo para Android e iOS             | Las aplicaciones móviles deben desarrollarse de forma nativa en Kotlin para Android y Swift para iOS, generando artefactos compatibles con las versiones definidas de cada plataforma y aprovechando sus capacidades de accesibilidad y notificaciones.                                                                               | Medium                        | Medium                                       |
