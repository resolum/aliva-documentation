...
<table>
    ...
    <tr>
        <td colspan="7"> Cuando el dispositivo móvil del usuario pierda temporalmente la conexión con el servicio en la nube durante una operación normal, el módulo de sincronización deberá detectar la pérdida de conectividad, restablecer la comunicación con el servicio en un tiempo máximo de 5 segundos, sin pérdida de datos. </td>
    </tr>
    <tr>
        <td> Availability </td>
...
<table>
    ...
    <tr>
        ...
        <td> Define que los datos o eventos se guarden temporalmente de manera local en la aplicación móvil en escenarios con conexión limitada y transmita la información hacia el servicio en la nube cuando se recupere la conexión. </td>
    </tr>
    <tr>
...
| QAS-03    | Seguridad ante comandos ML inciertos                     | Ante un comando de voz emitido por una persona con discapacidad motora severa, el módulo de control y comunicación debe interpretar y delegar su ejecución únicamente cuando la confianza del modelo al menos un 75%, alcanzando ≥ 85% de precisión del modelo y 0% de comandos ejecutados por debajo del umbral establecido.         | High                          | High                                         |
